...
class TI_Whitelabel_Loader {
	 ...
	 *                                    on the $component.
	 * @param    int    $priority         Optional. he priority at which the
	 *                                    function should be fired. Default is 10.
	...
	/**
	 * A utility function that is used to register the actions and hooks into
	 * a single collection.
	 *
	 * @since    0.1.0
	 * @access   private
